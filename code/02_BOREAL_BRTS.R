...
# RELATIONSHIPS IN THE BOREAL FOREST OF ALASKA FROM 1950-2009. THE SCRIPT USES THE 
# gbm, raster, and R.utils PACKAGES TO COMPLETE THIS ANALYSIS. R version 3.2.2 
...
save_dir <- paste(wdir,"BOREAL_FINAL_RESULTS/",sep="")
...
nobs    <- 4127 # NUMBER OF PIXELS TO RANDOMLY SELECT FROM STUDY DOMAIN TO CONDUCT
                # ANALYSIS
...
# PARTIAL DEPENDENCE FOR ANNUAL DEFICIT
